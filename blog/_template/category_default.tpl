...
<head>
    ...
    <title>{=$current_category_name=}|{=$base_title=}｜高槻駅徒歩3分の歯医者｜河原歯科クリニック</title>
    <meta name="keywords" content="{=$base_title=}{=$current_category_name=}">
    <meta name="description" content="{=$base_title=}{=$current_category_name=}">
				...
				<div class="header-wrap">
					<h1 class="logo">
						<a href="https://www.kawahara-dc.net/">
							<img src="../../images/logo.png" alt="{=$current_category_name=}｜{=$base_title=}">
						</a>
					</h1>
					<ul class="header-btn">
						<li>
               ...
               <section>
					   ...
					   <ul class="anchor_list blog_cate_list">
						...
						<ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="@$current_category_id">
								...
								<ONIf condition="$max_record_count > $limitNum">
									<ul class="blog_pager">
										<ONIf condition="$current_page <= 1">
											...
											<ONElse>
												<li><a href="./?p={=$current_page-1=}">&laquo;</a></li>
										</ONIf>
										<ONPagenationFetch>
							...
							?>
											<li><a href="./?p={=$current_page+1=}">&raquo;</a></li>
											<ONElse>
